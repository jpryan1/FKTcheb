...
#     best_deg = guess_fkt_err(lkern, x_vecs, dct_n, rtol)
#     println("Best deg is ", best_deg)
#     cfg = fkt_config(best_deg, d, dct_n, to, rtol)
#     # Perform FKTcheb
...
#     # display(cfg.to)
#     # Get FKTcheb error
#     println("err = ", norm(U_mat*V_mat-truth_mat)/norm(truth_mat))
#     @test isapprox(guess, truth_mat, rtol = 10rtol)
# end
# #
# @testset "4D" begin
#     d         = 4
...
#
#     # Get FKTcheb error
#     @test isapprox((U_mat*V_mat), truth_mat, rtol = 10rtol)
# end
#
#
# @testset "2D" begin
